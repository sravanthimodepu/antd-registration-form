          ...
          <div className="flex flex-wrap lg:flex-nowrap justify-center">
            ...
            <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
              <div className="flex justify-between items-center">
                <div>
                  <p className='font-bold text-gray-400'>Clients</p>
                  <p className='text-2xl'>71000</p>
                </div>
              </div>
              <div className="mt-6">
                <Button
            ...
            <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
              {earningData.map((item)=>(
                <div
                key={item.title}
                className = "flex flex-wrap justify-center gap-2  bg-gray-100 dark:text-gray-200 dark:bg-secondary-dark-bg md:w-56 p-4 pt-9 rounded-2xl"
                >
                  <button
                  type='button'
          ...
          <div className="flex gap-10 flex-wrap justify-center">
            <div className="bg-gray-100  dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
              <div className="flex justify-between">
                <p className='font-semibold text-xl'>Application Updates</p>
              ...
              <div className="mt-10 flex gap-10 flex-wrap justify-center">
                <div className='boreder-r-1 border-color m-4 pr-10'>
                  <div>
                    <p>
